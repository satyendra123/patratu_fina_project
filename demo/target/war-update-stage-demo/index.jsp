...
<div class="modal fade" id="addUserModal" tabindex="-1" role="dialog"
	...
	<div class="container">
		...
		<div class="row" style="margin-top:8px;">
			<div class="col-md-12">
				...
				<span id="syncDbAllDevicesStatus" style="margin-left:10px;font-weight:600;"></span>
			</div>
		</div>
		<!-- è¡¨æ ¼æ˜¾ç¤ºå†…å®¹ -->
		<div class="row">
	...
	<script type="text/javascript">
		...
		function applyUserSearchFilter(){
			var keyword = currentUserSearchKeyword;
			$("#emps_table tbody tr").each(function(){
				var row = $(this);
				var userIdText = normalizeUserSearchText(row.find("td:eq(2)").text());
				var userNameText = normalizeUserSearchText(row.find("td:eq(3)").text());
				var matched = (keyword === "")
